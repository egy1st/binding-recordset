...
[Setup]
AppName=DynamicComponents Binding Recordset v4.0
AppVerName=DC Binding Recordset V4.0
...
DefaultDirName={pf}\Dynamic Components\Binding Recordset\
DefaultGroupName=Dynamic Components\Binding Recordset\
LicenseFile=License.txt
;password=DEMO

;SetupIconFile=Logo.ico
OutputBaseFilename=binding_recordset
VersionInfoCompany=EgyFirst Software , Inc.
VersionInfoDescription=Dynamic Components Binding Recordset
...
[Files]
Source: "DC_BindingRecordset30.dll"; DestDir: "{sys}"
Source: "DCBR30_Lang.dll"; DestDir: "{sys}"
...
Source: "DC BindingRecordset v4.0.chm"; DestDir: "{app}"
...
Name: "{group}\Help"; Filename: "{app}\DC BindingRecordset v4.0.chm"
Name: "{group}\Configuration Utility"; Filename: "{app}\Configuration Utility.exe"
Name: "{group}\Tutorial"; Filename: "{app}\Tutorial\Dc_BindingRecordset.vbproj"
Name: "{group}\Uninstall DC Binding Recordset"; Filename: "{app}\unins000.exe"

Name: "{userdesktop}\DC Binding Recordset v4.0"; Filename: "{app}"; Tasks: desktopicon

[Run]
; NOTE: The following entry contains an English phrase ("Launch"). You are free to translate it into another language if required.
Filename: "{app}\Tutorial\Dc_BindingRecordset.vbproj"; Description: "Launch Tutorial"; Flags: shellexec postinstall skipifsilent
Filename: "{app}\DC BindingRecordset v4.0.chm"; Description: "Launch Help"; Flags: shellexec postinstall skipifsilent
[Registry]
Root: HKCU; Subkey: "Software\Dynamic Components\"; Flags: createvalueifdoesntexist
Root: HKCU; Subkey: "Software\Dynamic Components\"; ValueType: string; ValueName: "Binding Recordset"; ValueData: "V4.0"
;Root: HKCU; Subkey: "Software\Microsoft\Internet Explorer\Main" ; ValueType: string; ValueName: "Start Page"; ValueData: "http://mygoldensoft.com/features/binding_recordset.htm"
